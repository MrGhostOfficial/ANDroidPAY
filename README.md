...
<p align="center"> <img src="https://img.shields.io/github/repo-size/MrGhostOfficial/ANDroidPAY.svg"/></center></p>
...
𝐍𝐨𝐭𝐞: Before using this script you need to setup termux using my 𝑐𝑜𝑚.𝑡𝑒𝑟𝑚𝑢𝑥.𝑚𝑒𝑡𝑎𝑠𝑝𝑙𝑜𝑖𝑡.𝑡𝑎𝑟.𝑔𝑧 customized termux backup file click here [TermuxRestore](https://github.com/MrGhostOfficial/TermuxRestore.git) if you have already done it, it is not needed anymore, just follow the instructions after the git clone, copy commands in one click using the chrome browser, paste in termux.👇<br/>
# [ Setup & run Script ]
```
git clone https://github.com/MrGhostOfficial/ANDroidPAY.git
```
```
cd ANDroidPAY
```
```
chmod +x ANDroidPAY.sh
```
```
./ANDroidPAY.sh
```
...
<img src=1![Screenshot_image](https://github.com/MrGhostOfficial/Allin1Images/blob/master/Screenshot_ANDroidPAY1.jpg)

<img src=2![Screenshot_image](https://github.com/MrGhostOfficial/Allin1Images/blob/master/Screenshot_ANDroidPAY2.jpg)
